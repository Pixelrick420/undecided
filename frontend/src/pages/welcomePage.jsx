  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen text-center bg-black text-white">
      ...
      <div className="mt-4">
        <button
          style={{ backgroundColor: customGray }}
          className="mx-4 text-2xl h-10 w-36 border-2 border-black rounded-md"></button>
        <button className="mx-4 text-2xl h-10 w-36 bg-black border-2 border-custom-gray rounded-md"></button>
      </div>
    </div>
  );
};
